...
/*
int[,] array = GenerateRandom2DArray(3, 3);
...
// метод который меняет последнию и первую строку
...
//int[,] result = SwapRowsAndColumns(array);
PrintArray(array);
...
// 8 8 4  (0,0) (0,1) (0,2) //(0,2)(1,2)(2,2)
// 7 1 1  (1,0) (1,1) (1,2) //(0,1)(1,1)(2,1)
// 0 7 8  (2,0) (2,1) (2,2) //(0,0)(1,0)(2,0)
